...
ATTEMPT_MULTIPLIER = int(os.environ.get("ATTEMPT_MULTIPLIER", "100000"))

# 允许的 IPv4 段 —— 现在代表“生成的 IP 地址的前缀”，例如 "104.26." 会匹配 104.26.x.x
ALLOWED_IPV4_PREFIXES = [
    p.strip() for p in os.environ.get("ALLOWED_IPV4_PREFIXES", "104.26.,172.67.68.,172.67.69.,172.67.71.,172.67.72.,172.67.74.,172.67.75.").split(",") if p.strip()
]
